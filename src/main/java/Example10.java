...
public class Example10 {
	private static Logger logger = Logger.getLogger(Example10.class);
	...
	public static void main(String args[])
		...
		s.map(new Function<Element, Integer>() {
			@Override
			public Integer call(Element e) throws Exception {
				return e.text.length();
			}
		}).foreachRDD(new VoidFunction<JavaRDD<Integer>>() {
			@Override
			public void call(JavaRDD<Integer> t) throws Exception {
				t.foreach(new VoidFunction<Integer>() {
					
					@Override
					public void call(Integer t) throws Exception {
						logger.info("text characters: " + t);
					}
				});
			}
		});
